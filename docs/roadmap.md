...
| `v0.2.0` | Docker化 | image buildとcontainer起動でAPIを確認できる | Done |
...
| EPIC-002 Containerization | APIをDockerで起動する | Dockerfile、`.dockerignore`、docker buildとcontainer起動、README手順 | Done |
